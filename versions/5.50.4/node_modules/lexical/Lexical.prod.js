...
function tb(a,b,c){ob=!0;let d=100<performance.now()-pb;try{w(a,()=>{let e=v()||sb(a);var f=new Map,g=a.getRootElement(),h=a._editorState,k=a._blockCursorElement;let n=!1,m="";for(var p=0;p<b.length;p++){var l=b[p],r=l.type,u=l.target,x=ub(u,h);if(!(null===x&&u!==g||z(x)))if("characterData"===r){if(l=d&&B(x))a:{l=e;r=u;var y=x;if(C(l)){var A=l.anchor.getNode();if(A.is(y)&&l.format!==A.getFormat()){l=!1;break a}}l=3===r.nodeType&&y.isAttached()}l&&(y=D(a._window),r=l=null,null!==y&&y.anchorNode===
u&&(l=y.anchorOffset,r=y.focusOffset),u=u.nodeValue,null!==u&&vb(x,u,l,r,!1))}else if("childList"===r){n=!0;r=l.addedNodes;for(y=0;y<r.length;y++){A=r[y];var aa=wb(A),ba=A.parentNode;null==ba||A===k||null!==aa||"BR"===A.nodeName&&rb(A,ba,a)||(Wa&&(aa=A.innerText||A.nodeValue)&&(m+=aa),ba.removeChild(A))}l=l.removedNodes;r=l.length;if(0<r){y=0;for(A=0;A<r;A++)if(ba=l[A],"BR"===ba.nodeName&&rb(ba,u,a)||k===ba)u.appendChild(ba),y++;r!==y&&(u===g&&(x=h._nodeMap.get("root")),f.set(u,x))}}}if(0<f.size)for(let [pa,
qa]of f)if(F(qa))for(f=qa.getChildrenKeys(),g=pa.firstChild,h=0;h<f.length;h++)k=a.getElementByKey(f[h]),null!==k&&(null==g?(pa.appendChild(k),g=k):g!==k&&pa.replaceChild(k,g),g=g.nextSibling);else B(qa)&&qa.markDirty();f=c.takeRecords();if(0<f.length){for(g=0;g<f.length;g++)for(k=f[g],h=k.addedNodes,k=k.target,p=0;p<h.length;p++)x=h[p],u=x.parentNode,null==u||"BR"!==x.nodeName||rb(x,k,a)||u.removeChild(x);c.takeRecords()}null!==e&&(n&&(e.dirty=!0,xb(e)),Wa&&yb(a)&&e.insertRawText(m))})}finally{ob=
...
function hc(a,b,c){b=D(b._window);if(null!==b){var d=b.anchorNode,{anchorOffset:e,focusOffset:f}=b;if(null!==d&&(b=3===d.nodeType?d.nodeValue:null,d=ub(d),null!==b&&B(d))){if(b===bb&&c){let g=c.length;b=c;f=e=g}null!==b&&vb(d,b,e,f,a)}}}
function vb(a,b,c,d,e){let f=a;if(f.isAttached()&&(e||!f.isDirty())){let n=f.isComposing(),m=b;(n||e)&&b[b.length-1]===bb&&(m=b.slice(0,-1));b=f.getTextContent();if(e||m!==b)if(""===m)if(I(null),Ya||Za||ab)f.remove();else{let p=H();setTimeout(()=>{p.update(()=>{f.isAttached()&&f.remove()})},20)}else{e=f.getParent();b=ic();var g=f.getTextContentSize(),h=Yb(),k=f.getKey();f.isToken()||null!==h&&k===h&&!n||C(b)&&(null!==e&&!e.canInsertTextBefore()&&0===b.anchor.offset||b.anchor.key===a.__key&&0===b.anchor.offset&&
!f.canInsertTextBefore()||b.focus.key===a.__key&&b.focus.offset===g&&!f.canInsertTextAfter())?f.markDirty():(a=v(),C(a)&&null!==c&&null!==d&&(a.setTextNodeRange(f,c,f,d),f.isSegmented()&&(c=f.getTextContent(),c=K(c),f.replace(c),f=c)),f.setTextContent(m))}}}
function jc(a,b){if(b.isSegmented())return!0;if(!a.isCollapsed())return!1;a=a.anchor.offset;let c=b.getParentOrThrow(),d=b.isToken();return 0===a?((a=!b.canInsertTextBefore()||!c.canInsertTextBefore()||d)||(b=b.getPreviousSibling(),a=(B(b)||F(b)&&b.isInline())&&!b.canInsertTextAfter()),a):a===b.getTextContentSize()?!b.canInsertTextAfter()||!c.canInsertTextAfter()||d:!1}function kc(a,b){var c=a[b];return"string"===typeof c?(c=c.split(" "),a[b]=c):c}
...
function Gc(a){Hc(a.anchor);Hc(a.focus);return a}function Hc(a){for(;"element"===a.type;){var b=a.getNode(),c=a.offset;c===b.getChildrenSize()?(b=b.getChildAtIndex(c-1),c=!0):(b=b.getChildAtIndex(c),c=!1);if(B(b)){a.set(b.__key,c?b.getTextContentSize():0,"text");break}else if(!F(b))break;a.set(b.__key,c?b.getChildrenSize():0,"element")}}let N="",O="",Ic="",Jc,R,Kc,Lc=!1,Mc=!1,Nc,Oc=null,Pc,Qc,Zc,$c,ad,bd;
function cd(a,b){let c=Zc.get(a);if(null!==b){let d=dd(a);d.parentNode===b&&b.removeChild(d)}$c.has(a)||R._keyToDOMMap.delete(a);F(c)&&(a=ed(c,Zc),fd(a,0,a.length-1,null));void 0!==c&&lc(bd,Kc,Nc,c,"destroyed")}function fd(a,b,c,d){for(;b<=c;++b){let e=a[b];void 0!==e&&cd(e,d)}}function gd(a,b){a.setProperty("text-align",b)}
function hd(a,b){var c=Jc.theme.indent;if("string"===typeof c){let d=a.classList.contains(c);0<b&&!d?a.classList.add(c):1>b&&d&&a.classList.remove(c)}c=getComputedStyle(a).getPropertyValue("--lexical-indent-base-value")||"40px";a.style.setProperty("padding-inline-start",0===b?"":`calc(${b} * ${c})`)}function id(a,b){a=a.style;0===b?gd(a,""):1===b?gd(a,"left"):2===b?gd(a,"center"):3===b?gd(a,"right"):4===b?gd(a,"justify"):5===b?gd(a,"start"):6===b&&gd(a,"end")}
function jd(a,b,c){let d=$c.get(a);void 0===d&&q(60);let e=d.createDOM(Jc,R);var f=R._keyToDOMMap;e["__lexicalKey_"+R._key]=a;f.set(a,e);B(d)?e.setAttribute("data-lexical-text","true"):z(d)&&e.setAttribute("data-lexical-decorator","true");if(F(d)){a=d.__indent;f=d.__size;0!==a&&hd(e,a);if(0!==f){--f;a=ed(d,$c);var g=O;O="";kd(a,d,0,f,e,null);ld(d,e);O=g}a=d.__format;0!==a&&id(e,a);d.isInline()||md(null,d,e);oc(d)&&(N+="\n\n",Ic+="\n\n")}else f=d.getTextContent(),z(d)?(g=d.decorate(R,Jc),null!==g&&
nd(a,g),e.contentEditable="false"):B(d)&&(d.isDirectionless()||(O+=f)),N+=f,Ic+=f;null!==b&&(null!=c?b.insertBefore(e,c):(c=b.__lexicalLineBreak,null!=c?b.insertBefore(e,c):b.appendChild(e)));lc(bd,Kc,Nc,d,"created");return e}function kd(a,b,c,d,e,f){let g=N;for(N="";c<=d;++c)jd(a[c],e,f);oc(b)&&(N+="\n\n");e.__lexicalTextContent=N;N=g+N}function od(a,b){a=b.get(a);return Mb(a)||z(a)&&a.isInline()}
...
function pd(a,b){var c=Zc.get(a),d=$c.get(a);void 0!==c&&void 0!==d||q(61);var e=Lc||Qc.has(a)||Pc.has(a);let f=pc(R,a);if(c===d&&!e)return F(c)?(d=f.__lexicalTextContent,void 0!==d&&(N+=d,Ic+=d),d=f.__lexicalDirTextContent,void 0!==d&&(O+=d)):(d=c.getTextContent(),B(c)&&!c.isDirectionless()&&(O+=d),Ic+=d,N+=d),f;c!==d&&e&&lc(bd,Kc,Nc,d,"updated");if(d.updateDOM(c,f,Jc))return d=jd(a,null,null),null===b&&q(62),b.replaceChild(d,f),cd(a,null),d;if(F(c)&&F(d)){a=d.__indent;a!==c.__indent&&hd(f,a);a=
...
Jc),null!==e&&nd(a,e)):B(d)&&!d.isDirectionless()&&(O+=c),N+=c,Ic+=c;!Mc&&L(d)&&d.__cachedText!==Ic&&(d=d.getWritable(),d.__cachedText=Ic);return f}function nd(a,b){let c=R._pendingDecorators,d=R._decorators;if(null===c){if(d[a]===b)return;c=$b(R)}c[a]=b}function qd(a){a=a.nextSibling;null!==a&&a===R._blockCursorElement&&(a=a.nextSibling);return a}function dd(a){a=ad.get(a);void 0===a&&q(75);return a}
...
0,h.style="")}else{k=255;n=!1;m=h.getNodes();let p=m.length;for(let l=0;l<p;l++){let r=m[l];if(B(r)&&(n=!0,k&=r.getFormat(),0===k))break}h.format=n?k:0}}S(b,ca,void 0)}})}
function xd(a,b){w(b,()=>{let c=v();var d=D(b._window);let e=ic();if(d)if(C(c)){let g=c.anchor;var f=g.getNode();"element"===g.type&&0===g.offset&&c.isCollapsed()&&!L(f)&&1===bc().getChildrenSize()&&f.getTopLevelElementOrThrow().isEmpty()&&null!==e&&c.is(e)?(d.removeAllRanges(),c.dirty=!0):3!==a.detail||c.isCollapsed()||(d=c.focus.getNode(),f!==d&&(F(f)?f.select(0):f.getParentOrThrow().select(0)))}else"touch"===a.pointerType&&(f=d.anchorNode,null!==f&&(f=f.nodeType,1===f||3===f))&&(d=Nd(e,d,b),xb(d));
S(b,da,a)})}function td(a,b){let c=a.target;a=a.pointerType;c instanceof Node&&"touch"!==a&&w(b,()=>{z(ub(c))||(Gd=!0)})}function Od(a){if(!a.getTargetRanges)return null;a=a.getTargetRanges();return 0===a.length?null:a[0]}function Pd(a,b){return a!==b||F(a)||F(b)||!a.isToken()||!b.isToken()}
function zd(a,b){let c=a.inputType,d=Od(a);"deleteCompositionText"===c||Wa&&yb(b)||"insertCompositionText"!==c&&w(b,()=>{let e=v();if("deleteContentBackward"===c){if(null===e){var f=ic();if(!C(f))return;xb(f.clone())}if(C(e)){229===Bd&&a.timeStamp<Ad+30&&b.isComposing()&&e.anchor.key===e.focus.key?(I(null),Ad=0,setTimeout(()=>{w(b,()=>{I(null)})},30),C(e)&&(f=e.anchor.getNode(),f.markDirty(),e.format=f.getFormat(),e.style=f.getStyle())):(a.preventDefault(),S(b,ea,!0));return}}if(C(e)){f=a.data;null!==
...
c){case "insertFromYank":case "insertFromDrop":case "insertReplacementText":S(b,ka,a);break;case "insertFromComposition":I(null);S(b,ka,a);break;case "insertLineBreak":I(null);S(b,fa,!1);break;case "insertParagraph":I(null);Hd?(Hd=!1,S(b,fa,!1)):S(b,ja,void 0);break;case "insertFromPaste":case "insertFromPasteAsQuotation":S(b,la,a);break;case "deleteByComposition":Pd(h,g)&&S(b,ma,void 0);break;case "deleteByDrag":case "deleteByCut":S(b,ma,void 0);break;case "deleteContent":S(b,ea,!1);break;case "deleteWordBackward":S(b,
oa,!0);break;case "deleteWordForward":S(b,oa,!1);break;case "deleteHardLineBackward":case "deleteSoftLineBackward":S(b,ra,!0);break;case "deleteContentForward":case "deleteHardLineForward":case "deleteSoftLineForward":S(b,ra,!1);break;case "formatStrikeThrough":S(b,sa,"strikethrough");break;case "formatBold":S(b,sa,"bold");break;case "formatItalic":S(b,sa,"italic");break;case "formatUnderline":S(b,sa,"underline");break;case "historyUndo":S(b,ta,void 0);break;case "historyRedo":S(b,ua,void 0)}}})}
function wd(a,b){a.stopPropagation();w(b,()=>{var c=v(),d=a.data,e=Od(a);if(null!=d&&C(c)&&Kd(c,e,d,a.timeStamp,!1)){Id&&(Qd(b,d),Id=!1);var f=c.anchor,g=f.getNode();e=D(b._window);if(null===e)return;let h=f.offset;if(f=Xa&&!c.isCollapsed()&&B(g)&&null!==e.anchorNode)g=g.getTextContent().slice(0,h)+d+g.getTextContent().slice(h+c.focus.offset),e=e.anchorNode,f=g===(3===e.nodeType?e.nodeValue:null);f||S(b,ka,d);d=d.length;Wa&&1<d&&"insertCompositionText"===a.inputType&&!b.isComposing()&&(c.anchor.offset-=
d);Ya||Za||ab||!b.isComposing()||(Ad=0,I(null))}else hc(!1,b,null!==d?d:void 0),Id&&(Qd(b,d||void 0),Id=!1);G();c=H();zb(c)});Dd=null}function ud(a,b){w(b,()=>{let c=v();if(C(c)&&!b.isComposing()){let d=c.anchor,e=c.anchor.getNode();I(d.key);(a.timeStamp<Ad+30||"element"===d.type||!c.isCollapsed()||e.getFormat()!==c.format||e.getStyle()!==c.style)&&S(b,ka,cb)}})}
function Qd(a,b){var c=a._compositionKey;I(null);if(null!==c&&null!=b){if(""===b){b=J(c);a=Jb(a.getElementByKey(c));null!==a&&null!==a.nodeValue&&B(b)&&vb(b,a.nodeValue,null,null,!0);return}if("\n"===b[b.length-1]&&(c=v(),C(c))){b=c.focus;c.anchor.set(b.key,b.offset,b.type);S(a,Da,null);return}}hc(!0,a,b)}function vd(a,b){Wa?Id=!0:w(b,()=>{Qd(b,a.data)})}
function sd(a,b){Ad=a.timeStamp;Bd=a.keyCode;if(!b.isComposing()){var {keyCode:c,shiftKey:d,ctrlKey:e,metaKey:f,altKey:g}=a;if(!S(b,va,a)){if(39!==c||e||f||g)if(39!==c||g||d||!e&&!f)if(37!==c||e||f||g)if(37!==c||g||d||!e&&!f)if(38!==c||e||f)if(40!==c||e||f)if(13===c&&d)Hd=!0,S(b,Da,a);else if(32===c)S(b,Ga,a);else if(t&&e&&79===c)a.preventDefault(),Hd=!0,S(b,fa,!0);else if(13!==c||d)if(t?g||f?0:8===c||72===c&&e:e||g||f?0:8===c)8===c?S(b,Ha,a):(a.preventDefault(),S(b,ea,!0));else if(27===c)S(b,Ia,
a);else if(t?d||g||f?0:46===c||68===c&&e:e||g||f?0:46===c)46===c?S(b,Ja,a):(a.preventDefault(),S(b,ea,!1));else if(8===c&&(t?g:e))a.preventDefault(),S(b,oa,!0);else if(46===c&&(t?g:e))a.preventDefault(),S(b,oa,!1);else if(t&&f&&8===c)a.preventDefault(),S(b,ra,!0);else if(t&&f&&46===c)a.preventDefault(),S(b,ra,!1);else if(66===c&&!g&&(t?f:e))a.preventDefault(),S(b,sa,"bold");else if(85===c&&!g&&(t?f:e))a.preventDefault(),S(b,sa,"underline");else if(73===c&&!g&&(t?f:e))a.preventDefault(),S(b,sa,"italic");
else if(9!==c||g||e||f)if(90===c&&!d&&(t?f:e))a.preventDefault(),S(b,ta,void 0);else{var h=t?90===c&&f&&d:89===c&&e||90===c&&e&&d;h?(a.preventDefault(),S(b,ua,void 0)):Rd(b._editorState._selection)&&(h=d?!1:67===c?t?f:e:!1,h?(a.preventDefault(),S(b,Pa,a)):(h=d?!1:88===c?t?f:e:!1,h?(a.preventDefault(),S(b,Qa,a)):65===c&&(t?f:e)&&(a.preventDefault(),b.update(()=>{let k=bc();k.select(0,k.getChildrenSize())}))))}else S(b,Ka,a);else Hd=!1,S(b,Da,a);else S(b,Ca,a);else S(b,Ba,a);else S(b,Aa,a);else S(b,
za,a);else S(b,ya,a);else S(b,xa,a);(e||d||g||f)&&S(b,Ta,a)}}}function Sd(a){let b=a.__lexicalEventHandles;void 0===b&&(b=[],a.__lexicalEventHandles=b);return b}let Td=new Map;
function Ud(a){a=a.target;let b=D(null==a?null:9===a.nodeType?a.defaultView:a.ownerDocument.defaultView);if(null!==b){var c=Gb(b.anchorNode);if(null!==c){Gd&&(Gd=!1,w(c,()=>{var g=ic(),h=b.anchorNode;null!==h&&(h=h.nodeType,1===h||3===h)&&(g=Nd(g,b,c),xb(g))}));a=fc(c);a=a[a.length-1];var d=a._key,e=Td.get(d),f=e||a;f!==c&&Md(b,f,!1);Md(b,c,!0);c!==a?Td.set(d,c):e&&Td.delete(d)}}}
function Vd(a,b){0===Ed&&a.ownerDocument.addEventListener("selectionchange",Ud);Ed++;a.__lexicalEditor=b;let c=Sd(a);for(let d=0;d<yd.length;d++){let [e,f]=yd[d],g="function"===typeof f?h=>{!0!==h._lexicalHandled&&(h._lexicalHandled=!0,b.isEditable()&&f(h,b))}:h=>{if(!0!==h._lexicalHandled&&(h._lexicalHandled=!0,b.isEditable()))switch(e){case "cut":return S(b,Qa,h);case "copy":return S(b,Pa,h);case "paste":return S(b,la,h);case "dragstart":return S(b,Ma,h);case "dragover":return S(b,Na,h);case "dragend":return S(b,
...
class be extends Zd{static getType(){return"linebreak"}static clone(a){return new be(a.__key)}constructor(a){super(a)}getTextContent(){return"\n"}createDOM(){return document.createElement("br")}updateDOM(){return!1}static importDOM(){return{br:a=>{let b=a.parentElement,c,d;return null!==b&&((c=b.firstChild)===a||c.nextSibling===a&&3===c.nodeType&&null!==(c.textContent||"").match(/^[\s|\r?\n|\t]+$/))&&((d=b.lastChild)===a||d.previousSibling===a&&3===d.nodeType&&null!==(d.textContent||"").match(/^[\s|\r?\n|\t]+$/))?
null:{conversion:ce,priority:0}}}}static importJSON(){return de()}exportJSON(){return{type:"linebreak",version:1}}}function ce(){return{node:de()}}function de(){return uc(new be)}function Mb(a){return a instanceof be}function ee(a,b){return b&16?"code":b&128?"mark":b&32?"sub":b&64?"sup":null}function fe(a,b){return b&1?"strong":b&2?"em":"span"}
...
function he(a,b,c){let d=b.firstChild;c=c.isComposing();a+=c?bb:"";if(null==d)b.textContent=a;else if(b=d.nodeValue,b!==a)if(c||Wa){c=b.length;let e=a.length,f=0,g=0;for(;f<c&&f<e&&b[f]===a[f];)f++;for(;g+f<c&&g+f<e&&b[c-g-1]===a[e-g-1];)g++;a=[f,c-f-g,a.slice(f,e-g)];let [h,k,n]=a;0!==k&&d.deleteData(h,k);d.insertData(h,n)}else d.nodeValue=a}function ie(a,b){b=document.createElement(b);b.appendChild(a);return b}
class je extends Zd{static getType(){return"text"}static clone(a){return new je(a.__text,a.__key)}constructor(a,b){super(b);this.__text=a;this.__format=0;this.__style="";this.__detail=this.__mode=0}getFormat(){return this.getLatest().__format}getDetail(){return this.getLatest().__detail}getMode(){let a=this.getLatest();return kb[a.__mode]}getStyle(){return this.getLatest().__style}isToken(){return 1===this.getLatest().__mode}isComposing(){return this.__key===Yb()}isSegmented(){return 2===this.getLatest().__mode}isDirectionless(){return 0!==
(this.getLatest().__detail&1)}isUnmergeable(){return 0!==(this.getLatest().__detail&2)}hasFormat(a){a=fb[a];return 0!==(this.getFormat()&a)}isSimpleText(){return"text"===this.__type&&0===this.__mode}getTextContent(){return this.getLatest().__text}getFormatFlags(a,b){let c=this.getLatest().__format;return Kb(c,a,b)}createDOM(a){var b=this.__format,c=ee(this,b);let d=fe(this,b),e=document.createElement(null===c?d:c),f=e;null!==c&&(f=document.createElement(d),e.appendChild(f));c=f;he(this.__text,c,this);
a=a.theme.text;void 0!==a&&ge(d,0,b,c,a);b=this.__style;""!==b&&(e.style.cssText=b);return e}updateDOM(a,b,c){let d=this.__text;var e=a.__format,f=this.__format,g=ee(this,e);let h=ee(this,f);var k=fe(this,e);let n=fe(this,f);if((null===g?k:g)!==(null===h?n:h))return!0;if(g===h&&k!==n)return e=b.firstChild,null==e&&q(48),a=g=document.createElement(n),he(d,a,this),c=c.theme.text,void 0!==c&&ge(n,0,f,a,c),b.replaceChild(g,e),!1;k=b;null!==h&&null!==g&&(k=b.firstChild,null==k&&q(49));he(d,k,this);c=c.theme.text;
void 0!==c&&e!==f&&ge(n,e,f,k,c);f=this.__style;a.__style!==f&&(b.style.cssText=f);return!1}static importDOM(){return{"#text":()=>({conversion:ke,priority:0}),b:()=>({conversion:le,priority:0}),code:()=>({conversion:me,priority:0}),em:()=>({conversion:me,priority:0}),i:()=>({conversion:me,priority:0}),s:()=>({conversion:me,priority:0}),span:()=>({conversion:ne,priority:0}),strong:()=>({conversion:me,priority:0}),sub:()=>({conversion:me,priority:0}),sup:()=>({conversion:me,priority:0}),u:()=>({conversion:me,
priority:0})}}static importJSON(a){let b=K(a.text);b.setFormat(a.format);b.setDetail(a.detail);b.setMode(a.mode);b.setStyle(a.style);return b}exportDOM(a){({element:a}=super.exportDOM(a));null!==a&&(this.hasFormat("bold")&&(a=ie(a,"b")),this.hasFormat("italic")&&(a=ie(a,"i")),this.hasFormat("strikethrough")&&(a=ie(a,"s")),this.hasFormat("underline")&&(a=ie(a,"u")));return{element:a}}exportJSON(){return{detail:this.getDetail(),format:this.getFormat(),mode:this.getMode(),style:this.getStyle(),text:this.getTextContent(),
type:"text",version:1}}selectionTransform(){}setFormat(a){let b=this.getWritable();b.__format="string"===typeof a?fb[a]:a;return b}setDetail(a){let b=this.getWritable();b.__detail="string"===typeof a?gb[a]:a;return b}setStyle(a){let b=this.getWritable();b.__style=a;return b}toggleFormat(a){a=fb[a];return this.setFormat(this.getFormat()^a)}toggleDirectionless(){let a=this.getWritable();a.__detail^=1;return a}toggleUnmergeable(){let a=this.getWritable();a.__detail^=2;return a}setMode(a){a=jb[a];if(this.__mode===
a)return this;let b=this.getWritable();b.__mode=a;return b}setTextContent(a){if(this.__text===a)return this;let b=this.getWritable();b.__text=a;return b}select(a,b){G();let c=v();var d=this.getTextContent();let e=this.__key;"string"===typeof d?(d=d.length,void 0===a&&(a=d),void 0===b&&(b=d)):b=a=0;if(C(c))d=Yb(),d!==c.anchor.key&&d!==c.focus.key||I(e),c.setTextNodeRange(this,a,this,b);else return oe(e,a,e,b,"text","text");return c}spliceText(a,b,c,d){let e=this.getWritable(),f=e.__text,g=c.length,
h=a;0>h&&(h=g+h,0>h&&(h=0));let k=v();d&&C(k)&&(a+=g,k.setTextNodeRange(e,a,e,a));b=f.slice(0,h)+c+f.slice(h+b);e.__text=b;return e}canInsertTextBefore(){return!0}canInsertTextAfter(){return!0}splitText(...a){G();var b=this.getLatest(),c=b.getTextContent(),d=b.__key,e=Yb(),f=new Set(a);a=[];var g=c.length,h="";for(var k=0;k<g;k++)""!==h&&f.has(k)&&(a.push(h),h=""),h+=c[k];""!==h&&a.push(h);f=a.length;if(0===f)return[];if(a[0]===c)return[b];var n=a[0];c=b.getParentOrThrow();k=b.getFormat();let m=b.getStyle(),
p=b.__detail;g=!1;b.isSegmented()?(h=K(n),h.__format=k,h.__style=m,h.__detail=p,g=!0):(h=b.getWritable(),h.__text=n);b=v();h=[h];n=n.length;for(let u=1;u<f;u++){var l=a[u],r=l.length;l=K(l).getWritable();l.__format=k;l.__style=m;l.__detail=p;let x=l.__key;r=n+r;if(C(b)){let y=b.anchor,A=b.focus;y.key===d&&"text"===y.type&&y.offset>n&&y.offset<=r&&(y.key=x,y.offset-=n,b.dirty=!0);A.key===d&&"text"===A.type&&A.offset>n&&A.offset<=r&&(A.key=x,A.offset-=n,b.dirty=!0)}e===d&&I(x);n=r;h.push(l)}d=this.getPreviousSibling();
e=this.getNextSibling();null!==d&&Xb(d);null!==e&&Xb(e);d=c.getWritable();e=this.getIndexWithinParent();g?(d.splice(e,0,h),this.remove()):d.splice(e,1,h);C(b)&&Yd(b,c,e,f-1);return h}mergeWithSibling(a){var b=a===this.getPreviousSibling();b||a===this.getNextSibling()||q(50);var c=this.__key;let d=a.__key,e=this.__text,f=e.length;Yb()===d&&I(c);let g=v();if(C(g)){let h=g.anchor,k=g.focus;null!==h&&h.key===d&&(pe(h,b,c,a,f),g.dirty=!0);null!==k&&k.key===d&&(pe(k,b,c,a,f),g.dirty=!0)}c=a.__text;this.setTextContent(b?
c+e:e+c);b=this.getWritable();a.remove();return b}isTextEntity(){return!1}}
function ne(a){let b="700"===a.style.fontWeight,c="line-through"===a.style.textDecoration,d="italic"===a.style.fontStyle,e="underline"===a.style.textDecoration,f=a.style.verticalAlign;return{forChild:g=>{if(!B(g))return g;b&&g.toggleFormat("bold");c&&g.toggleFormat("strikethrough");d&&g.toggleFormat("italic");e&&g.toggleFormat("underline");"sub"===f&&g.toggleFormat("subscript");"super"===f&&g.toggleFormat("superscript");return g},node:null}}
function le(a){let b="normal"===a.style.fontWeight;return{forChild:c=>{B(c)&&!b&&c.toggleFormat("bold");return c},node:null}}let qe=new WeakMap;
function ke(a){if(null===a.parentElement)throw Error("Expected parentElement of Text not to be null");for(var b=a.textContent||"",c,d=a.parentNode,e=[a];null!==d&&void 0===(c=qe.get(d))&&!("PRE"===d.nodeName||1===d.nodeType&&d.style.whiteSpace.startsWith("pre"));)e.push(d),d=d.parentNode;c=void 0===c?d:c;for(d=0;d<e.length;d++)qe.set(e[d],c);if(null!==c){b=b.split(/(\r?\n|\t)/);a=[];e=b.length;for(c=0;c<e;c++)d=b[c],"\n"===d||"\r\n"===d?a.push(de()):"\t"===d?a.push(re()):""!==d&&a.push(K(d));return{node:a}}b=
b.replace(/\r?\n|\t/gm," ").replace("\r","").replace(/\s+/g," ");if(""===b)return{node:null};if(" "===b[0]){e=a;for(c=!0;null!==e&&null!==(e=se(e,!1));)if(d=e.textContent||"",0<d.length){d.match(/(?:\s|\r?\n|\t)$/)&&(b=b.slice(1));c=!1;break}c&&(b=b.slice(1))}if(" "===b[b.length-1]){for(e=!0;null!==a&&null!==(a=se(a,!0));)if(0<(a.textContent||"").replace(/^[\s|\r?\n|\t]+/,"").length){e=!1;break}e&&(b=b.slice(0,b.length-1))}return""===b?{node:null}:{node:K(b)}}
let te=new RegExp(/^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/,"i");function se(a,b){for(;;){for(var c=void 0;null===(c=b?a.nextSibling:a.previousSibling);)if(a=a.parentElement,null===a)return null;a=c;if(1===a.nodeType&&(c=a.style.display,""===c&&null===a.nodeName.match(te)||""!==c&&!c.startsWith("inline")))return null;for(;null!==(c=b?a.firstChild:a.lastChild);)a=c;if(3===a.nodeType)return a;if("BR"===a.nodeName)return null}}
let ue={code:"code",em:"italic",i:"italic",s:"strikethrough",strong:"bold",sub:"subscript",sup:"superscript",u:"underline"};function me(a){let b=ue[a.nodeName.toLowerCase()];return void 0===b?{node:null}:{forChild:c=>{B(c)&&!c.hasFormat(b)&&c.toggleFormat(b);return c},node:null}}function K(a=""){return uc(new je(a))}function B(a){return a instanceof je}
class ve extends je{static getType(){return"tab"}static clone(a){let b=new ve(a.__key);b.__text=a.__text;b.__format=a.__format;b.__style=a.__style;return b}constructor(a){super("\t",a);this.__detail=2}static importDOM(){return null}static importJSON(a){let b=re();b.setFormat(a.format);b.setStyle(a.style);return b}exportJSON(){return{...super.exportJSON(),type:"tab",version:1}}setTextContent(){throw Error("TabNode does not support setTextContent");}setDetail(){throw Error("TabNode does not support setDetail");
}setMode(){throw Error("TabNode does not support setMode");}canInsertTextBefore(){return!1}canInsertTextAfter(){return!1}}function re(){return uc(new ve)}
class we{constructor(a,b,c){this._selection=null;this.key=a;this.offset=b;this.type=c}is(a){return this.key===a.key&&this.offset===a.offset&&this.type===a.type}isBefore(a){let b=this.getNode(),c=a.getNode(),d=this.offset;a=a.offset;if(F(b)){var e=b.getDescendantByIndex(d);b=null!=e?e:b}F(c)&&(e=c.getDescendantByIndex(a),c=null!=e?e:c);return b===c?d<a:b.isBefore(c)}getNode(){let a=J(this.key);null===a&&q(20);return a}set(a,b,c){let d=this._selection,e=this.key;this.key=a;this.offset=b;this.type=c;
Zb()||(Yb()===e&&I(a),null!==d&&(d._cachedNodes=null,d.dirty=!0))}}function xe(a,b){let c=b.__key,d=a.offset,e="element";if(B(b))e="text",b=b.getTextContentSize(),d>b&&(d=b);else if(!F(b)){var f=b.getNextSibling();if(B(f))c=f.__key,d=0,e="text";else if(f=b.getParent())c=f.__key,d=b.getIndexWithinParent()+1}a.set(c,d,e)}function $d(a,b){if(F(b)){let c=b.getLastDescendant();F(c)||B(c)?xe(a,c):xe(a,b)}else xe(a,b)}
function ye(a,b,c,d){let e=a.getNode(),f=e.getChildAtIndex(a.offset),g=K(),h=L(e)?ae().append(g):g;g.setFormat(c);g.setStyle(d);null===f?e.append(h):f.insertBefore(h);a.is(b)&&b.set(g.__key,0,"text");a.set(g.__key,0,"text")}function Ie(a,b,c,d){a.key=b;a.offset=c;a.type=d}
class Je{constructor(a){this.dirty=!1;this._nodes=a;this._cachedNodes=null}is(a){if(!Rd(a))return!1;let b=this._nodes,c=a._nodes;return b.size===c.size&&Array.from(b).every(d=>c.has(d))}add(a){this.dirty=!0;this._nodes.add(a);this._cachedNodes=null}delete(a){this.dirty=!0;this._nodes.delete(a);this._cachedNodes=null}clear(){this.dirty=!0;this._nodes.clear();this._cachedNodes=null}has(a){return this._nodes.has(a)}clone(){return new Je(new Set(this._nodes))}extract(){return this.getNodes()}insertRawText(){}insertText(){}insertNodes(a,
...
function C(a){return a instanceof Ke}
class Le{constructor(a,b,c){this.gridKey=a;this.anchor=b;this.focus=c;this.dirty=!1;this._cachedNodes=null;b._selection=this;c._selection=this}is(a){return Me(a)?this.gridKey===a.gridKey&&this.anchor.is(a.anchor)&&this.focus.is(a.focus):!1}set(a,b,c){this.dirty=!0;this.gridKey=a;this.anchor.key=b;this.focus.key=c;this._cachedNodes=null}clone(){return new Le(this.gridKey,this.anchor,this.focus)}isCollapsed(){return!1}isBackward(){return this.focus.isBefore(this.anchor)}getCharacterOffsets(){return Ne(this)}extract(){return this.getNodes()}insertRawText(){}insertText(){}insertNodes(a,b){let c=
...
startColumn:A,startRow:aa}=x;h=Math.min(h,A);k=Math.min(k,aa);n=Math.max(n,A+y.__colSpan-1);m=Math.max(m,aa+y.__rowSpan-1)}var b=this._cachedNodes;if(null!==b)return b;var c=this.anchor.getNode();b=this.focus.getNode();c=zc(c,Oe);var d=zc(b,Oe);Oe(c)||q(103);Oe(d)||q(104);b=c.getParent();Pe(b)||q(105);b=b.getParent();Qe(b)||q(106);let [e,f,g]=Re(b,c,d),h=Math.min(f.startColumn,g.startColumn),k=Math.min(f.startRow,g.startRow),n=Math.max(f.startColumn+f.cell.__colSpan-1,g.startColumn+g.cell.__colSpan-
1),m=Math.max(f.startRow+f.cell.__rowSpan-1,g.startRow+g.cell.__rowSpan-1);c=h;d=k;for(var p=h,l=k;h<c||k<d||n>p||m>l;){if(h<c){var r=l-d;--c;for(var u=0;u<=r;u++)a(e[d+u][c])}if(k<d)for(r=p-c,--d,u=0;u<=r;u++)a(e[d][c+u]);if(n>p)for(r=l-d,p+=1,u=0;u<=r;u++)a(e[d+u][p]);if(m>l)for(r=p-c,l+=1,u=0;u<=r;u++)a(e[l][c+u])}b=[b];c=null;for(d=k;d<=m;d++)for(p=h;p<=n;p++)({cell:l}=e[d][p]),r=l.getParent(),Pe(r)||q(107),r!==c&&b.push(r),b.push(l,...Ac(l)),c=r;Zb()||(this._cachedNodes=b);return b}getTextContent(){let a=
this.getNodes(),b="";for(let c=0;c<a.length;c++)b+=a[c].getTextContent();return b}}function Me(a){return a instanceof Le}
...
b=c.getNode();let e=d.offset;d=c.offset;F(a)&&(c=a.getDescendantByIndex(e),a=null!=c?c:a);F(b)&&(c=b.getDescendantByIndex(d),null!==c&&c!==a&&b.getChildAtIndex(d)===c&&(c=c.getPreviousSibling()),b=null!=c?c:b);a=a.is(b)?F(a)&&0<a.getChildrenSize()?[]:[a]:a.getNodesBetween(b);Zb()||(this._cachedNodes=a);return a}setTextNodeRange(a,b,c,d){Ie(this.anchor,a.__key,b,"text");Ie(this.focus,c.__key,d,"text");this._cachedNodes=null;this.dirty=!0}getTextContent(){let a=this.getNodes();if(0===a.length)return"";
let b=a[0],c=a[a.length-1],d=this.anchor,e=this.focus,f=d.isBefore(e),[g,h]=Ne(this),k="",n=!0;for(let m=0;m<a.length;m++){let p=a[m];if(F(p)&&!p.isInline())n||(k+="\n"),n=p.isEmpty()?!1:!0;else if(n=!1,B(p)){let l=p.getTextContent();if(p===b)if(p===c){if("element"!==d.type||"element"!==e.type||e.offset===d.offset)l=g<h?l.slice(g,h):l.slice(h,g)}else l=f?l.slice(g):l.slice(h);else p===c&&(l=f?l.slice(0,h):l.slice(0,g));k+=l}else!z(p)&&!Mb(p)||p===c&&this.isCollapsed()||(k+=p.getTextContent())}return k}applyDOMRange(a){let b=
H(),c=b.getEditorState()._selection;a=Se(a.startContainer,a.startOffset,a.endContainer,a.endOffset,b,c);if(null!==a){var [d,e]=a;Ie(this.anchor,d.key,d.offset,d.type);Ie(this.focus,e.key,e.offset,e.type);this._cachedNodes=null}}clone(){let a=this.anchor,b=this.focus;return new Ke(new we(a.key,a.offset,a.type),new we(b.key,b.offset,b.type),this.format,this.style)}toggleFormat(a){this.format=Kb(this.format,a,null);this.dirty=!0}setStyle(a){this.style=a;this.dirty=!0}hasFormat(a){return 0!==(this.format&
fb[a])}insertRawText(a){a=a.split(/(\r?\n|\t)/);let b=[],c=a.length;for(let d=0;d<c;d++){let e=a[d];"\n"===e||"\r\n"===e?b.push(de()):"\t"===e?b.push(re()):b.push(K(e))}this.insertNodes(b)}insertText(a){var b=this.anchor,c=this.focus,d=this.isCollapsed()||b.isBefore(c),e=this.format,f=this.style;d&&"element"===b.type?ye(b,c,e,f):d||"element"!==c.type||ye(c,b,e,f);var g=this.getNodes(),h=g.length,k=d?c:b;c=(d?b:c).offset;var n=k.offset;b=g[0];B(b)||q(26);d=b.getTextContent().length;var m=b.getParentOrThrow(),
p=g[h-1];if(this.isCollapsed()&&c===d&&(b.isSegmented()||b.isToken()||!b.canInsertTextAfter()||!m.canInsertTextAfter()&&null===b.getNextSibling())){var l=b.getNextSibling();B(l)&&l.canInsertTextBefore()&&!Ib(l)||(l=K(),l.setFormat(e),m.canInsertTextAfter()?b.insertAfter(l):m.insertAfter(l));l.select(0,0);b=l;if(""!==a){this.insertText(a);return}}else if(this.isCollapsed()&&0===c&&(b.isSegmented()||b.isToken()||!b.canInsertTextBefore()||!m.canInsertTextBefore()&&null===b.getPreviousSibling())){l=b.getPreviousSibling();
if(!B(l)||Ib(l))l=K(),l.setFormat(e),m.canInsertTextBefore()?b.insertBefore(l):m.insertBefore(l);l.select();b=l;if(""!==a){this.insertText(a);return}}else if(b.isSegmented()&&c!==d)m=K(b.getTextContent()),m.setFormat(e),b.replace(m),b=m;else if(!(this.isCollapsed()||""===a||(l=p.getParent(),m.canInsertTextBefore()&&m.canInsertTextAfter()&&(!F(l)||l.canInsertTextBefore()&&l.canInsertTextAfter())))){this.insertText("");Te(this.anchor,this.focus,null);this.insertText(a);return}if(1===h)if(b.isToken())a=
...
d=null!==d?d:f.getParentOrThrow(),e.push(f);else if(c===d)d=f;else{if(f.isToken())return!1;[d,f]=f.splitText(c);e.push(f)}f=d;e.push(...g);g=a[0];var k=!1,n=null;for(let r=0;r<a.length;r++){var m=a[r];if(M(d)||z(d)||!F(m)||m.isInline())k&&!F(m)&&!z(m)&&M(d.getParent())&&q(28);else{if(m.is(g)){if(F(d)&&d.isEmpty()&&d.canReplaceWith(m)){d.replace(m);d=m;k=!0;continue}k=m.getFirstDescendant();if(Lb(k)){for(var p=k.getParentOrThrow();p.isInline();)p=p.getParentOrThrow();n=p.getChildren();k=n.length;if(F(d)){var l=
...
b)for(h=0;h<b;h++)a.append(c[h]);if(0!==d)for(c=0;c<d;c++)b=e[c],null===f?g.append(b):f.insertBefore(b),f=b;g.canBeEmpty()||0!==g.getChildrenSize()?g.selectStart():(g.selectPrevious(),g.remove())}}insertLineBreak(a){let b=de();var c=this.anchor;"element"===c.type&&(c=c.getNode(),L(c)&&this.insertParagraph());a?this.insertNodes([b],!0):this.insertNodes([b])&&b.selectNext(0,0)}getCharacterOffsets(){return Ne(this)}extract(){var a=this.getNodes(),b=a.length,c=b-1,d=this.anchor;let e=this.focus;var f=
a[0];let g=a[c],[h,k]=Ne(this);if(0===b)return[];if(1===b)return B(f)&&!this.isCollapsed()?(a=h>k?k:h,c=f.splitText(a,h>k?h:k),a=0===a?c[0]:c[1],null!=a?[a]:[]):[f];b=d.isBefore(e);B(f)&&(d=b?h:k,d===f.getTextContentSize()?a.shift():0!==d&&([,f]=f.splitText(d),a[0]=f));B(g)&&(f=g.getTextContent().length,b=b?k:h,0===b?a.pop():b!==f&&([g]=g.splitText(b),a[c]=g));return a}modify(a,b,c){var d=this.focus,e=this.anchor,f="move"===a,g=nc(d,b);if(z(g)&&!g.isIsolated())f&&g.isKeyboardSelectable()?(b=Ve(),
...
d.rangeCount&&(g=d.getRangeAt(0),e=this.anchor.getNode(),e=L(e)?e:sc(e),this.applyDOMRange(g),this.dirty=!0,!f)){f=this.getNodes();a=[];c=!1;for(h=0;h<f.length;h++)k=f[h],rc(k,e)?a.push(k):c=!0;c&&0<a.length&&(b?(b=a[0],F(b)?b.selectStart():b.getParentOrThrow().selectStart()):(b=a[a.length-1],F(b)?b.selectEnd():b.getParentOrThrow().selectEnd()));if(d.anchorNode!==g.startContainer||d.anchorOffset!==g.startOffset)b=this.focus,f=this.anchor,d=f.key,g=f.offset,e=f.type,Ie(f,b.key,b.offset,b.type),Ie(b,
d,g,e),this._cachedNodes=null}}}deleteCharacter(a){let b=this.isCollapsed();if(this.isCollapsed()){var c=this.anchor,d=this.focus,e=c.getNode();if(!a&&("element"===c.type&&F(e)&&c.offset===e.getChildrenSize()||"text"===c.type&&c.offset===e.getTextContentSize())){var f=e.getParent();f=e.getNextSibling()||(null===f?null:f.getNextSibling());if(F(f)&&f.isShadowRoot())return}f=nc(d,a);if(z(f)&&!f.isIsolated()){f.isKeyboardSelectable()&&F(e)&&0===e.getChildrenSize()?(e.remove(),a=Ve(),a.add(f.__key),xb(a)):
(f.remove(),H().dispatchCommand(ca,void 0));return}if(!a&&F(f)&&F(e)&&e.isEmpty()){e.remove();f.selectStart();return}this.modify("extend",a,"character");if(!this.isCollapsed()){f="text"===d.type?d.getNode():null;e="text"===c.type?c.getNode():null;if(null!==f&&f.isSegmented()){if(c=d.offset,d=f.getTextContentSize(),f.is(e)||a&&c!==d||!a&&0!==c){We(f,a,c);return}}else if(null!==e&&e.isSegmented()&&(c=c.offset,d=e.getTextContentSize(),e.is(f)||a&&0!==c||!a&&c!==d)){We(e,a,c);return}e=this.anchor;f=this.focus;
c=e.getNode();d=f.getNode();if(c===d&&"text"===e.type&&"text"===f.type){var g=e.offset,h=f.offset;let k=g<h;d=k?g:h;h=k?h:g;g=h-1;d!==g&&(c=c.getTextContent().slice(d,h),ec(c)||(a?f.offset=g:e.offset=g))}}else if(a&&0===c.offset&&("element"===c.type?c.getNode():c.getNode().getParentOrThrow()).collapseAtStart(this))return}this.removeText();a&&!b&&this.isCollapsed()&&"element"===this.anchor.type&&0===this.anchor.offset&&(a=this.anchor.getNode(),a.isEmpty()&&L(a.getParent())&&0===a.getIndexWithinParent()&&
a.collapseAtStart(this))}deleteLine(a){this.isCollapsed()&&("text"===this.anchor.type&&this.modify("extend",a,"lineboundary"),0===(a?this.focus:this.anchor).offset&&this.modify("extend",a,"character"));this.removeText()}deleteWord(a){this.isCollapsed()&&this.modify("extend",a,"word");this.removeText()}}function Rd(a){return a instanceof Je}function Xe(a){let b=a.offset;if("text"===a.type)return b;a=a.getNode();return b===a.getChildrenSize()?a.getTextContent().length:0}
function Ne(a){let b=a.anchor;a=a.focus;return"element"===b.type&&"element"===a.type&&b.key===a.key&&b.offset===a.offset?[0,0]:[Xe(b),Xe(a)]}function We(a,b,c){let d=a.getTextContent().split(/(?=\s)/g),e=d.length,f=0,g=0;for(let h=0;h<e;h++){let k=d[h],n=h===e-1;g=f;f+=k.length;if(b&&f===c||f>c||n){d.splice(h,1);n&&(g=void 0);break}}b=d.join("").trim();""===b?a.remove():(a.setTextContent(b),a.select(g,g))}
...
B(a)?(d=a,f=null,e=h?a.getTextContentSize():0):a!==f&&h&&!g&&e++}else e=f.getIndexWithinParent(),e=0===b&&z(f)&&dc(a)===f?e:e+1,f=f.getParentOrThrow();if(F(f))return new we(f.__key,e,"element")}}else d=dc(a);return B(d)?new we(d.__key,e,"text"):null}
function Ze(a,b,c){var d=a.offset,e=a.getNode();0===d?(d=e.getPreviousSibling(),e=e.getParent(),b)?(c||!b)&&null===d&&F(e)&&e.isInline()&&(b=e.getPreviousSibling(),B(b)&&(a.key=b.__key,a.offset=b.getTextContent().length)):F(d)&&!c&&d.isInline()?(a.key=d.__key,a.offset=d.getChildrenSize(),a.type="element"):B(d)&&(a.key=d.__key,a.offset=d.getTextContent().length):d===e.getTextContent().length&&(d=e.getNextSibling(),e=e.getParent(),b&&F(d)&&d.isInline()?(a.key=d.__key,a.offset=0,a.type="element"):(c||
b)&&null===d&&F(e)&&e.isInline()&&!e.canInsertTextAfter()&&(b=e.getNextSibling(),B(b)&&(a.key=b.__key,a.offset=0)))}function Te(a,b,c){if("text"===a.type&&"text"===b.type){var d=a.isBefore(b);let e=a.is(b);Ze(a,d,e);Ze(b,!d,e);e&&(b.key=a.key,b.offset=a.offset,b.type=a.type);d=H();d.isComposing()&&d._compositionKey!==a.key&&C(c)&&(d=c.anchor,c=c.focus,Ie(a,d.key,d.offset,d.type),Ie(b,c.key,c.offset,c.type))}}
function Se(a,b,c,d,e,f){if(null===a||null===c||!Fb(e,a,c))return null;b=Ye(a,b,C(f)?f.anchor:null,e);if(null===b)return null;d=Ye(c,d,C(f)?f.focus:null,e);if(null===d||"element"===b.type&&"element"===d.type&&(a=dc(a),c=dc(c),z(a)&&z(c)))return null;Te(b,d,f);return[b,d]}function Ue(a){return F(a)&&!a.isInline()}function oe(a,b,c,d,e,f){let g=Vb();a=new Ke(new we(a,b,e),new we(c,d,f),0,"");a.dirty=!0;return g._selection=a}function Ve(){return new Je(new Set)}
function $e(a){let b=a.getEditorState()._selection,c=D(a._window);return Rd(b)||Me(b)?b.clone():Nd(b,c,a)}
function Nd(a,b,c){var d=c._window;if(null===d)return null;var e=d.event,f=e?e.type:void 0;d="selectionchange"===f;e=!ob&&(d||"beforeinput"===f||"compositionstart"===f||"compositionend"===f||"click"===f&&e&&3===e.detail||"drop"===f||void 0===f);let g;if(!C(a)||e){if(null===b)return null;e=b.anchorNode;f=b.focusNode;g=b.anchorOffset;b=b.focusOffset;if(d&&C(a)&&!Fb(c,e,f))return a.clone()}else return a.clone();c=Se(e,g,f,b,c,a);if(null===c)return null;let [h,k]=c;return new Ke(h,k,C(a)?a.format:0,C(a)?
a.style:"")}function v(){return Vb()._selection}function ic(){return H()._editorState._selection}
function Yd(a,b,c,d=1){var e=a.anchor,f=a.focus,g=e.getNode(),h=f.getNode();if(b.is(g)||b.is(h)){g=b.__key;if(a.isCollapsed()){if(b=e.offset,c<=b&&0<d||c<b&&0>d)c=Math.max(0,b+d),e.set(g,c,"element"),f.set(g,c,"element"),af(a)}else{let n=a.isBackward();h=n?f:e;var k=h.getNode();e=n?e:f;f=e.getNode();b.is(k)&&(k=h.offset,(c<=k&&0<d||c<k&&0>d)&&h.set(g,Math.max(0,k+d),"element"));b.is(f)&&(b=e.offset,(c<=b&&0<d||c<b&&0>d)&&e.set(g,Math.max(0,b+d),"element"))}af(a)}}
...
function Xd(a,b,c,d,e){let f=null,g=0,h=null;null!==d?(f=d.__key,B(d)?(g=d.getTextContentSize(),h="text"):F(d)&&(g=d.getChildrenSize(),h="element")):null!==e&&(f=e.__key,B(e)?h="text":F(e)&&(h="element"));null!==f&&null!==h?a.set(f,g,h):(g=b.getIndexWithinParent(),-1===g&&(g=c.getChildrenSize()),a.set(c.__key,g,"element"))}function pe(a,b,c,d,e){"text"===a.type?(a.key=c,b||(a.offset+=e)):a.offset>d.getIndexWithinParent()&&--a.offset}
function Re(a,b,c){let d=[],e=null,f=null;a=a.getChildren();for(let m=0;m<a.length;m++){var g=a[m];Pe(g)||q(108);var h=g.getChildren();g=0;for(let p of h){for(Oe(p)||q(109);void 0!==d[m]&&void 0!==d[m][g];)g++;h=m;var k=g,n=p;let l={cell:n,startColumn:k,startRow:h},r=n.__rowSpan,u=n.__colSpan;for(let x=0;x<r;x++){void 0===d[h+x]&&(d[h+x]=[]);for(let y=0;y<u;y++)d[h+x][k+y]=l}b.is(n)&&(e=l);c.is(n)&&(f=l);g+=p.__colSpan}}null===e&&q(110);null===f&&q(111);return[d,e,f]}
let T=null,Y=null,Z=!1,cf=!1,Ub=0,df={characterData:!0,childList:!0,subtree:!0};function Zb(){return Z||null!==T&&T._readOnly}function G(){Z&&q(13)}function Vb(){null===T&&q(15);return T}function H(){null===Y&&q(16);return Y}function ef(a,b,c){var d=b.__type;let e=a._nodes.get(d);void 0===e&&q(30);a=c.get(d);void 0===a&&(a=Array.from(e.transforms),c.set(d,a));c=a.length;for(d=0;d<c&&(a[d](b),b.isAttached());d++);}
function ff(a,b){b=b._dirtyLeaves;a=a._nodeMap;for(let c of b)b=a.get(c),B(b)&&b.isAttached()&&b.isSimpleText()&&!b.isUnmergeable()&&Fc(b)}
function gf(a,b){let c=b._dirtyLeaves,d=b._dirtyElements;a=a._nodeMap;let e=Yb(),f=new Map;var g=c;let h=g.size;for(var k=d,n=k.size;0<h||0<n;){if(0<h){b._dirtyLeaves=new Set;for(let m of g)g=a.get(m),B(g)&&g.isAttached()&&g.isSimpleText()&&!g.isUnmergeable()&&Fc(g),void 0!==g&&void 0!==g&&g.__key!==e&&g.isAttached()&&ef(b,g,f),c.add(m);g=b._dirtyLeaves;h=g.size;if(0<h){Ub++;continue}}b._dirtyLeaves=new Set;b._dirtyElements=new Map;for(let m of k)if(k=m[0],n=m[1],"root"===k||n)g=a.get(k),void 0!==
g&&void 0!==g&&g.__key!==e&&g.isAttached()&&ef(b,g,f),d.set(k,n);g=b._dirtyLeaves;h=g.size;k=b._dirtyElements;n=k.size;Ub++}b._dirtyLeaves=c;b._dirtyElements=d}function hf(a,b){var c=b.get(a.type);void 0===c&&q(17);c=c.klass;a.type!==c.getType()&&q(18);c=c.importJSON(a);a=a.children;if(F(c)&&Array.isArray(a))for(let d=0;d<a.length;d++){let e=hf(a[d],b);c.append(e)}return c}function jf(a,b){let c=T,d=Z,e=Y;T=a;Z=!0;Y=null;try{return b()}finally{T=c,Z=d,Y=e}}
function kf(a){let b=a._pendingEditorState,c=a._rootElement,d=a._headless||null===c;if(null!==b){var e=a._editorState,f=e._selection,g=b._selection,h=0!==a._dirtyType,k=T,n=Z,m=Y,p=a._updating,l=a._observer,r=null;a._pendingEditorState=null;a._editorState=b;if(!d&&h&&null!==l){Y=a;T=b;Z=!1;a._updating=!0;try{let E=a._dirtyType,P=a._dirtyElements,Q=a._dirtyLeaves;l.disconnect();var u=E,x=P,y=Q;O=Ic=N="";Lc=2===u;Oc=null;R=a;Jc=a._config;Kc=a._nodes;Nc=R._listeners.mutation;Pc=x;Qc=y;Zc=e._nodeMap;
$c=b._nodeMap;Mc=b._readOnly;ad=new Map(a._keyToDOMMap);let ha=new Map;bd=ha;pd("root",null);bd=ad=Jc=$c=Zc=Qc=Pc=Kc=R=void 0;r=ha}catch(E){E instanceof Error&&a._onError(E);if(cf)throw E;lf(a,null,c,b);Ab(a);a._dirtyType=2;cf=!0;kf(a);cf=!1;return}finally{l.observe(c,df),a._updating=p,T=k,Z=n,Y=m}}b._readOnly||(b._readOnly=!0);var A=a._dirtyLeaves,aa=a._dirtyElements,ba=a._normalizedNodes,pa=a._updateTags,qa=a._deferred;h&&(a._dirtyType=0,a._cloneNotNeeded.clear(),a._dirtyLeaves=new Set,a._dirtyElements=
new Map,a._normalizedNodes=new Set,a._updateTags=new Set);var ze=a._decorators,Nb=a._pendingDecorators||ze,Af=b._nodeMap,Rc;for(Rc in Nb)Af.has(Rc)||(Nb===ze&&(Nb=$b(a)),delete Nb[Rc]);var ia=d?null:D(a._window);if(a._editable&&null!==ia&&(h||null===g||g.dirty)){Y=a;T=b;try{null!==l&&l.disconnect();if(h||null===g||g.dirty){let E=a._blockCursorElement;null!==E&&xc(E,a,c);a:{let P=ia.anchorNode,Q=ia.focusNode,ha=ia.anchorOffset,lb=ia.focusOffset,V=document.activeElement;if(!(pa.has("collaboration")&&
V!==c||null!==V&&Eb(V)))if(C(g)){var mb=g.anchor,Sc=g.focus,Ae=mb.key,Bf=Sc.key,Be=pc(a,Ae),Ce=pc(a,Bf),Ob=mb.offset,De=Sc.offset,Tc=g.format,Uc=g.style,Ee=g.isCollapsed(),nb=Be,Pb=Ce,Vc=!1;if("text"===mb.type){nb=Jb(Be);let W=mb.getNode();Vc=W.getFormat()!==Tc||W.getStyle()!==Uc}else C(f)&&"text"===f.anchor.type&&(Vc=!0);"text"===Sc.type&&(Pb=Jb(Ce));if(null!==nb&&null!==Pb){if(Ee&&(null===f||Vc||C(f)&&(f.format!==Tc||f.style!==Uc))){var Cf=performance.now();Jd=[Tc,Uc,Ob,Ae,Cf]}if(ha===Ob&&lb===
De&&P===nb&&Q===Pb&&("Range"!==ia.type||!Ee)&&(null!==V&&c.contains(V)||c.focus({preventScroll:!0}),"element"!==mb.type))break a;try{ia.setBaseAndExtent(nb,Ob,Pb,De)}catch(W){}if(!pa.has("skip-scroll-into-view")&&g.isCollapsed()&&null!==c&&c===document.activeElement){let W=g instanceof Ke&&"element"===g.anchor.type?nb.childNodes[Ob]||null:0<ia.rangeCount?ia.getRangeAt(0):null;if(null!==W){let X;if(W instanceof Text){let U=document.createRange();U.selectNode(W);X=U.getBoundingClientRect()}else X=W.getBoundingClientRect();
let wa=c.ownerDocument,Ea=wa.defaultView;if(null!==Ea)for(var {top:Wc,bottom:Xc}=X,Qb,Rb,na=c;null!==na;){let U=na===wa.body;if(U)Qb=0,Rb=Bb(a).innerHeight;else{let Sb=na.getBoundingClientRect();Qb=Sb.top;Rb=Sb.bottom}let Fa=0;Wc<Qb?Fa=-(Qb-Wc):Xc>Rb&&(Fa=Xc-Rb);if(0!==Fa)if(U)Ea.scrollBy(0,Fa);else{let Sb=na.scrollTop;na.scrollTop+=Fa;let Fe=na.scrollTop-Sb;Wc-=Fe;Xc-=Fe}if(U)break;na=Hb(na)}}}Fd=!0}}else null!==f&&Fb(a,P,Q)&&ia.removeAllRanges()}}a:{let E=a._blockCursorElement;if(C(g)&&g.isCollapsed()&&
"element"===g.anchor.type&&c.contains(document.activeElement)){let P=g.anchor,Q=P.getNode(),ha=P.offset,lb=Q.getChildrenSize(),V=!1,W=null;if(ha===lb){let X=Q.getChildAtIndex(ha-1);wc(X)&&(V=!0)}else{let X=Q.getChildAtIndex(ha);if(wc(X)){let wa=X.getPreviousSibling();if(null===wa||wc(wa))V=!0,W=a.getElementByKey(X.__key)}}if(V){let X=a.getElementByKey(Q.__key);if(null===E){let wa=a._config.theme,Ea=document.createElement("div");Ea.contentEditable="false";Ea.setAttribute("data-lexical-cursor","true");
let U=wa.blockCursor;if(void 0!==U){if("string"===typeof U){let Fa=U.split(" ");U=wa.blockCursor=Fa}void 0!==U&&Ea.classList.add(...U)}a._blockCursorElement=E=Ea}c.style.caretColor="transparent";null===W?X.appendChild(E):X.insertBefore(E,W);break a}}null!==E&&xc(E,a,c)}null!==l&&l.observe(c,df)}finally{Y=m,T=k}}if(null!==r){var Df=r;let E=Array.from(a._listeners.mutation),P=E.length;for(let Q=0;Q<P;Q++){let [ha,lb]=E[Q],V=Df.get(lb);void 0!==V&&ha(V,{dirtyLeaves:A,updateTags:pa})}}C(g)||null===g||
null!==f&&f.is(g)||a.dispatchCommand(ca,void 0);var Yc=a._pendingDecorators;null!==Yc&&(a._decorators=Yc,a._pendingDecorators=null,mf("decorator",a,!0,Yc));var Ef=ac(e),Ge=ac(b);Ef!==Ge&&mf("textcontent",a,!0,Ge);mf("update",a,!0,{dirtyElements:aa,dirtyLeaves:A,editorState:b,normalizedNodes:ba,prevEditorState:e,tags:pa});a._deferred=[];if(0!==qa.length){let E=a._updating;a._updating=!0;try{for(let P=0;P<qa.length;P++)qa[P]()}finally{a._updating=E}}var He=a._updates;if(0!==He.length){let E=He.shift();
if(E){let [P,Q]=E;nf(a,P,Q)}}}}function mf(a,b,c,...d){let e=b._updating;b._updating=c;try{let f=Array.from(b._listeners[a]);for(a=0;a<f.length;a++)f[a].apply(null,d)}finally{b._updating=e}}function S(a,b,c){if(!1===a._updating||Y!==a){let f=!1;a.update(()=>{f=S(a,b,c)});return f}let d=fc(a);for(let f=4;0<=f;f--)for(let g=0;g<d.length;g++){var e=d[g]._commands.get(b);if(void 0!==e&&(e=e[f],void 0!==e)){e=Array.from(e);let h=e.length;for(let k=0;k<h;k++)if(!0===e[k](c,a))return!0}}return!1}
function of(a,b){let c=a._updates;for(b=b||!1;0!==c.length;){var d=c.shift();if(d){let [e,f]=d,g;void 0!==f&&(d=f.onUpdate,g=f.tag,f.skipTransforms&&(b=!0),d&&a._deferred.push(d),g&&a._updateTags.add(g));e()}}return b}
function nf(a,b,c){let d=a._updateTags;var e,f=e=!1;if(void 0!==c){var g=c.onUpdate;e=c.tag;null!=e&&d.add(e);e=c.skipTransforms||!1;f=c.discrete||!1}g&&a._deferred.push(g);c=a._editorState;g=a._pendingEditorState;let h=!1;if(null===g||g._readOnly)g=a._pendingEditorState=new pf(new Map((g||c)._nodeMap)),h=!0;g._flushSync=f;f=T;let k=Z,n=Y,m=a._updating;T=g;Z=!1;a._updating=!0;Y=a;try{h&&(a._headless?null!=c._selection&&(g._selection=c._selection.clone()):g._selection=$e(a));let p=a._compositionKey;
b();e=of(a,e);bf(g,a);0!==a._dirtyType&&(e?ff(g,a):gf(g,a),of(a),Cc(c,g,a._dirtyLeaves,a._dirtyElements));p!==a._compositionKey&&(g._flushSync=!0);let l=g._selection;if(C(l)){let r=g._nodeMap,u=l.focus.key;void 0!==r.get(l.anchor.key)&&void 0!==r.get(u)||q(19)}else Rd(l)&&0===l._nodes.size&&(g._selection=null)}catch(p){p instanceof Error&&a._onError(p);a._pendingEditorState=c;a._dirtyType=2;a._cloneNotNeeded.clear();a._dirtyLeaves=new Set;a._dirtyElements.clear();kf(a);return}finally{T=f,Z=k,Y=n,
a._updating=m,Ub=0}0!==a._dirtyType||qf(g,a)?g._flushSync?(g._flushSync=!1,kf(a)):h&&Db(()=>{kf(a)}):(g._flushSync=!1,h&&(d.clear(),a._deferred=[],a._pendingEditorState=null))}function w(a,b,c){a._updating?a._updates.push([b,c]):nf(a,b,c)}class rf extends Zd{constructor(a){super(a)}decorate(){q(47)}isIsolated(){return!1}isInline(){return!0}isKeyboardSelectable(){return!0}}function z(a){return a instanceof rf}
class sf extends Zd{constructor(a){super(a);this.__last=this.__first=null;this.__indent=this.__format=this.__size=0;this.__dir=null}getFormat(){return this.getLatest().__format}getFormatType(){let a=this.getFormat();return ib[a]||""}getIndent(){return this.getLatest().__indent}getChildren(){let a=[],b=this.getFirstChild();for(;null!==b;)a.push(b),b=b.getNextSibling();return a}getChildrenKeys(){let a=[],b=this.getFirstChild();for(;null!==b;)a.push(b.__key),b=b.getNextSibling();return a}getChildrenSize(){return this.getLatest().__size}isEmpty(){return 0===
...
0,b=this.getChildren(),c=b.length;for(let d=0;d<c;d++){let e=b[d];a+=e.getTextContentSize();F(e)&&d!==c-1&&!e.isInline()&&(a+=2)}return a}getDirection(){return this.getLatest().__dir}hasFormat(a){return""!==a?(a=hb[a],0!==(this.getFormat()&a)):!1}select(a,b){G();let c=v(),d=a,e=b;var f=this.getChildrenSize();if(!this.canBeEmpty())if(0===a&&0===b){if(a=this.getFirstChild(),B(a)||F(a))return a.select(0,0)}else if(!(void 0!==a&&a!==f||void 0!==b&&b!==f)&&(a=this.getLastChild(),B(a)||F(a)))return a.select();
void 0===d&&(d=f);void 0===e&&(e=f);f=this.__key;if(C(c))c.anchor.set(f,d,"element"),c.focus.set(f,e,"element"),c.dirty=!0;else return oe(f,d,f,e,"element","element");return c}selectStart(){let a=this.getFirstDescendant();return F(a)||B(a)?a.select(0,0):null!==a?a.selectPrevious():this.select(0,0)}selectEnd(){let a=this.getLastDescendant();return F(a)||B(a)?a.select():null!==a?a.selectNext():this.select()}clear(){let a=this.getWritable();this.getChildren().forEach(b=>b.remove());return a}append(...a){return this.splice(this.getChildrenSize(),
0,a)}setDirection(a){let b=this.getWritable();b.__dir=a;return b}setFormat(a){this.getWritable().__format=""!==a?hb[a]:0;return this}setIndent(a){this.getWritable().__indent=a;return this}splice(a,b,c){let d=c.length,e=this.getChildrenSize(),f=this.getWritable(),g=f.__key;var h=[],k=[];let n=this.getChildAtIndex(a+b),m=null,p=e-b+d;if(0!==a)if(a===e)m=this.getLastChild();else{var l=this.getChildAtIndex(a);null!==l&&(m=l.getPreviousSibling())}if(0<b){var r=null===m?this.getFirstChild():m.getNextSibling();
...
l.__key,b.__next=n.__key):a.__prev=null);f.__size=p;if(k.length&&(a=v(),C(a))){k=new Set(k);h=new Set(h);let {anchor:y,focus:A}=a;tf(y,k,h)&&Xd(y,y.getNode(),this,m,n);tf(A,k,h)&&Xd(A,A.getNode(),this,m,n);0!==p||this.canBeEmpty()||M(this)||this.remove()}return f}exportJSON(){return{children:[],direction:this.getDirection(),format:this.getFormatType(),indent:this.getIndent(),type:"element",version:1}}insertNewAfter(){return null}canIndent(){return!0}collapseAtStart(){return!1}excludeFromCopy(){return!1}canExtractContents(){return!0}canReplaceWith(){return!0}canInsertAfter(){return!0}canBeEmpty(){return!0}canInsertTextBefore(){return!0}canInsertTextAfter(){return!0}isInline(){return!1}isShadowRoot(){return!1}canMergeWith(){return!1}extractWithChild(){return!1}}
function F(a){return a instanceof sf}function tf(a,b,c){for(a=a.getNode();a;){let d=a.__key;if(b.has(d)&&!c.has(d))return!0;a=a.getParent()}return!1}
class uf extends sf{static getType(){return"root"}static clone(){return new uf}constructor(){super("root");this.__cachedText=null}getTopLevelElementOrThrow(){q(51)}getTextContent(){let a=this.__cachedText;return!Zb()&&0!==H()._dirtyType||null===a?super.getTextContent():a}remove(){q(52)}replace(){q(53)}insertBefore(){q(54)}insertAfter(){q(55)}updateDOM(){return!1}append(...a){for(let b=0;b<a.length;b++){let c=a[b];F(c)||z(c)||q(56)}return super.append(...a)}static importJSON(a){let b=bc();b.setFormat(a.format);
b.setIndent(a.indent);b.setDirection(a.direction);return b}exportJSON(){return{children:[],direction:this.getDirection(),format:this.getFormatType(),indent:this.getIndent(),type:"root",version:1}}collapseAtStart(){return!0}}function L(a){return a instanceof uf}function qf(a,b){b=b.getEditorState()._selection;a=a._selection;if(null!==a){if(a.dirty||!a.is(b))return!0}else if(null!==b)return!0;return!1}function vf(){return new pf(new Map([["root",new uf]]))}
function wf(a){let b=a.exportJSON();b.type!==a.constructor.getType()&&q(58);let c=b.children;if(F(a)){Array.isArray(c)||q(59);a=a.getChildren();for(let d=0;d<a.length;d++){let e=wf(a[d]);c.push(e)}}return b}
class pf{constructor(a,b){this._nodeMap=a;this._selection=b||null;this._readOnly=this._flushSync=!1}isEmpty(){return 1===this._nodeMap.size&&null===this._selection}read(a){return jf(this,a)}clone(a){a=new pf(this._nodeMap,void 0===a?this._selection:a);a._readOnly=!0;return a}toJSON(){return jf(this,()=>({root:wf(bc())}))}}
class xf extends sf{static getType(){return"paragraph"}static clone(a){return new xf(a.__key)}createDOM(a){let b=document.createElement("p");a=kc(a.theme,"paragraph");void 0!==a&&b.classList.add(...a);return b}updateDOM(){return!1}static importDOM(){return{p:()=>({conversion:yf,priority:0})}}exportDOM(a){({element:a}=super.exportDOM(a));a&&this.isEmpty()&&a.append(document.createElement("br"));if(a){var b=this.getFormatType();a.style.textAlign=b;if(b=this.getDirection())a.dir=b;b=this.getIndent();
...
0;b<a.length;b++){let c=a[b].getType();if(!this._nodes.has(c))return!1}return!0}dispatchCommand(a,b){return S(this,a,b)}getDecorators(){return this._decorators}getRootElement(){return this._rootElement}getKey(){return this._key}setRootElement(a){let b=this._rootElement;if(a!==b){let e=kc(this._config.theme,"root");var c=this._pendingEditorState||this._editorState;this._rootElement=a;lf(this,b,a,c);if(null!==b){if(!this._config.disableEvents){0!==Ed&&(Ed--,0===Ed&&b.ownerDocument.removeEventListener("selectionchange",
Ud));c=b.__lexicalEditor;if(null!==c&&void 0!==c){if(null!==c._parentEditor){var d=fc(c);d=d[d.length-1]._key;Td.get(d)===c&&Td.delete(d)}else Td.delete(c._key);b.__lexicalEditor=null}c=Sd(b);for(d=0;d<c.length;d++)c[d]();b.__lexicalEventHandles=[]}null!=e&&b.classList.remove(...e)}null!==a?(c=(c=a.ownerDocument)&&c.defaultView||null,d=a.style,d.userSelect="text",d.whiteSpace="pre-wrap",d.wordBreak="break-word",a.setAttribute("data-lexical-editor","true"),this._window=c,this._dirtyType=2,Ab(this),
this._updateTags.add("history-merge"),kf(this),this._config.disableEvents||Vd(a,this),null!=e&&a.classList.add(...e)):this._window=null;mf("root",this,!1,a,b)}}getElementByKey(a){return this._keyToDOMMap.get(a)||null}getEditorState(){return this._editorState}setEditorState(a,b){a.isEmpty()&&q(38);zb(this);let c=this._pendingEditorState,d=this._updateTags;b=void 0!==b?b.tag:null;null===c||c.isEmpty()||(null!=b&&d.add(b),kf(this));this._pendingEditorState=a;this._dirtyType=2;this._dirtyElements.set("root",
!1);this._compositionKey=null;null!=b&&d.add(b);kf(this)}parseEditorState(a,b){a="string"===typeof a?JSON.parse(a):a;let c=vf(),d=T,e=Z,f=Y,g=this._dirtyElements,h=this._dirtyLeaves,k=this._cloneNotNeeded,n=this._dirtyType;this._dirtyElements=new Map;this._dirtyLeaves=new Set;this._cloneNotNeeded=new Set;this._dirtyType=0;T=c;Z=!1;Y=this;try{hf(a.root,this._nodes),b&&b(),c._readOnly=!0}catch(m){m instanceof Error&&this._onError(m)}finally{this._dirtyElements=g,this._dirtyLeaves=h,this._cloneNotNeeded=
k,this._dirtyType=n,T=d,Z=e,Y=f}return c}update(a,b){w(this,a,b)}focus(a,b={}){let c=this._rootElement;null!==c&&(c.setAttribute("autocapitalize","off"),w(this,()=>{let d=v(),e=bc();null!==d?d.dirty=!0:0!==e.getChildrenSize()&&("rootStart"===b.defaultSelection?e.selectStart():e.selectEnd())},{onUpdate:()=>{c.removeAttribute("autocapitalize");a&&a()},tag:"focus"}),null===this._pendingEditorState&&c.removeAttribute("autocapitalize"))}blur(){var a=this._rootElement;null!==a&&a.blur();a=D(this._window);
null!==a&&a.removeAllRanges()}isEditable(){return this._editable}setEditable(a){this._editable!==a&&(this._editable=a,mf("editable",this,!0,a))}toJSON(){return{editorState:this._editorState.toJSON()}}}
class Gf extends sf{constructor(a,b){super(b);this.__colSpan=a;this.__rowSpan=1}exportJSON(){return{...super.exportJSON(),colSpan:this.__colSpan,rowSpan:this.__rowSpan}}getColSpan(){return this.__colSpan}setColSpan(a){this.getWritable().__colSpan=a;return this}getRowSpan(){return this.__rowSpan}setRowSpan(a){this.getWritable().__rowSpan=a;return this}}function Oe(a){return a instanceof Gf}class Hf extends sf{}function Qe(a){return a instanceof Hf}class If extends sf{}
function Pe(a){return a instanceof If}exports.$addUpdateTag=function(a){G();H()._updateTags.add(a)};exports.$applyNodeReplacement=uc;exports.$copyNode=tc;exports.$createLineBreakNode=de;exports.$createNodeSelection=Ve;exports.$createParagraphNode=ae;exports.$createRangeSelection=function(){let a=new we("root",0,"element"),b=new we("root",0,"element");return new Ke(a,b,0,"")};exports.$createTabNode=re;exports.$createTextNode=K;exports.$getAdjacentNode=nc;exports.$getNearestNodeFromDOMNode=ub;
exports.$getNearestRootOrShadowRoot=sc;exports.$getNodeByKey=J;exports.$getPreviousSelection=ic;exports.$getRoot=bc;exports.$getSelection=v;exports.$getTextContent=function(){let a=v();return null===a?"":a.getTextContent()};exports.$hasAncestor=rc;exports.$hasUpdateTag=function(a){return H()._updateTags.has(a)};exports.$insertNodes=function(a,b){let c=v();null===c&&(c=bc().selectEnd());return c.insertNodes(a,b)};exports.$isBlockElementNode=Ue;exports.$isDecoratorNode=z;exports.$isElementNode=F;
exports.$isInlineElementOrDecoratorNode=function(a){return F(a)&&a.isInline()||z(a)&&a.isInline()};exports.$isLeafNode=Lb;exports.$isLineBreakNode=Mb;exports.$isNodeSelection=Rd;exports.$isParagraphNode=function(a){return a instanceof xf};exports.$isRangeSelection=C;exports.$isRootNode=L;exports.$isRootOrShadowRoot=M;exports.$isTabNode=function(a){return a instanceof ve};exports.$isTextNode=B;
exports.$nodesOfType=function(a){var b=Vb();let c=b._readOnly,d=a.getType();b=b._nodeMap;let e=[];for(let [,f]of b)f instanceof a&&f.__type===d&&(c||f.isAttached())&&e.push(f);return e};exports.$normalizeSelection__EXPERIMENTAL=Gc;exports.$parseSerializedNode=function(a){return hf(a,H()._nodes)};exports.$setCompositionKey=I;exports.$setSelection=xb;exports.$splitNode=yc;exports.BLUR_COMMAND=Sa;exports.CAN_REDO_COMMAND={};exports.CAN_UNDO_COMMAND={};exports.CLEAR_EDITOR_COMMAND={};
exports.CLEAR_HISTORY_COMMAND={};exports.CLICK_COMMAND=da;exports.COMMAND_PRIORITY_CRITICAL=4;exports.COMMAND_PRIORITY_EDITOR=0;exports.COMMAND_PRIORITY_HIGH=3;exports.COMMAND_PRIORITY_LOW=1;exports.COMMAND_PRIORITY_NORMAL=2;exports.CONTROLLED_TEXT_INSERTION_COMMAND=ka;exports.COPY_COMMAND=Pa;exports.CUT_COMMAND=Qa;exports.DELETE_CHARACTER_COMMAND=ea;exports.DELETE_LINE_COMMAND=ra;exports.DELETE_WORD_COMMAND=oa;exports.DEPRECATED_$computeGridMap=Re;
exports.DEPRECATED_$createGridSelection=function(){let a=new we("root",0,"element"),b=new we("root",0,"element");return new Le("root",a,b)};exports.DEPRECATED_$getNodeTriplet=function(a){a instanceof Gf||(a instanceof Zd?(a=zc(a,Oe),Oe(a)||q(114)):(a=zc(a.getNode(),Oe),Oe(a)||q(114)));let b=a.getParent();Pe(b)||q(115);let c=b.getParent();Qe(c)||q(116);return[a,b,c]};exports.DEPRECATED_$isGridCellNode=Oe;exports.DEPRECATED_$isGridNode=Qe;exports.DEPRECATED_$isGridRowNode=Pe;
exports.DEPRECATED_$isGridSelection=Me;exports.DEPRECATED_GridCellNode=Gf;exports.DEPRECATED_GridNode=Hf;exports.DEPRECATED_GridRowNode=If;exports.DRAGEND_COMMAND=Oa;exports.DRAGOVER_COMMAND=Na;exports.DRAGSTART_COMMAND=Ma;exports.DROP_COMMAND=La;exports.DecoratorNode=rf;exports.ElementNode=sf;exports.FOCUS_COMMAND=Ra;exports.FORMAT_ELEMENT_COMMAND={};exports.FORMAT_TEXT_COMMAND=sa;exports.INDENT_CONTENT_COMMAND={};exports.INSERT_LINE_BREAK_COMMAND=fa;exports.INSERT_PARAGRAPH_COMMAND=ja;
exports.INSERT_TAB_COMMAND={};exports.KEY_ARROW_DOWN_COMMAND=Ca;exports.KEY_ARROW_LEFT_COMMAND=za;exports.KEY_ARROW_RIGHT_COMMAND=xa;exports.KEY_ARROW_UP_COMMAND=Ba;exports.KEY_BACKSPACE_COMMAND=Ha;exports.KEY_DELETE_COMMAND=Ja;exports.KEY_DOWN_COMMAND=va;exports.KEY_ENTER_COMMAND=Da;exports.KEY_ESCAPE_COMMAND=Ia;exports.KEY_MODIFIER_COMMAND=Ta;exports.KEY_SPACE_COMMAND=Ga;exports.KEY_TAB_COMMAND=Ka;exports.LineBreakNode=be;exports.MOVE_TO_END=ya;exports.MOVE_TO_START=Aa;
exports.OUTDENT_CONTENT_COMMAND={};exports.PASTE_COMMAND=la;exports.ParagraphNode=xf;exports.REDO_COMMAND=ua;exports.REMOVE_TEXT_COMMAND=ma;exports.RootNode=uf;exports.SELECTION_CHANGE_COMMAND=ca;exports.TabNode=ve;exports.TextNode=je;exports.UNDO_COMMAND=ta;exports.createCommand=function(){return{}};
exports.createEditor=function(a){var b=a||{},c=Y,d=b.theme||{};let e=void 0===a?c:b.parentEditor||null,f=b.disableEvents||!1,g=vf(),h=b.namespace||(null!==e?e._config.namespace:gc()),k=b.editorState,n=[uf,je,be,ve,xf,...(b.nodes||[])],m=b.onError;b=void 0!==b.editable?b.editable:!0;if(void 0===a&&null!==c)a=c._nodes;else for(a=new Map,c=0;c<n.length;c++){let l=n[c],r=null;var p=null;"function"!==typeof l&&(p=l,l=p.replace,r=p.with,p=p.withKlass?p.withKlass:null);let u=l.getType(),x=l.transform(),
y=new Set;null!==x&&y.add(x);a.set(u,{klass:l,replace:r,replaceWithKlass:p,transforms:y})}d=new Ff(g,e,a,{disableEvents:f,namespace:h,theme:d},m?m:console.error,zf(a),b);void 0!==k&&(d._pendingEditorState=k,d._dirtyType=2);return d};exports.getNearestEditorFromDOMNode=Gb;exports.isSelectionCapturedInDecoratorInput=Eb;exports.isSelectionWithinEditor=Fb
